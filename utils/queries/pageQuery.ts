import { ImagePart, ImagesPart, PostPart, SectionPart, SeoPart, SeriesPartNoSeo } from "@/utils/queries/fragments";
...
export const queryCalcPage = `${ImagePart} ${ImagesPart} ${SectionPart} query CalcPage ($locale: I18NLocaleCode) { calculator(locale: $locale) { __typename data { __typename id attributes { title shortText sections { ...SectionPart } seo { ...SeoPart } } } } }`
